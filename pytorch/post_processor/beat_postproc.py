# -----------------------------------------------------------------------------
# NOTE: Upstream code acknowledgement (unmodified)
# Source project : Beat This! (ISMIR 2024)
# Source repo    : https://github.com/CPJKU/beat_this
# Code path      : https://github.com/CPJKU/beat_this/blob/main/beat_this/model/postprocessor.py
# Snapshot date  : 2025-07-28
# Modification   : None — this file is an UNMODIFIED copy.
# Thanks to the Beat This authors for releasing the original implementation.
# License        : See the LICENSE file in the upstream repository for terms.
# -----------------------------------------------------------------------------
